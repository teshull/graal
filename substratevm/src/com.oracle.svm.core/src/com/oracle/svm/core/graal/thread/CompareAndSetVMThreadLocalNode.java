...
public class CompareAndSetVMThreadLocalNode extends AbstractStateSplit implements Lowerable {
    ...
    public void lower(LoweringTool tool) {
        ...
        UnsafeCompareAndSwapNode atomic = graph().add(new UnsafeCompareAndSwapNode(holder, offset, expect, update, threadLocalInfo.storageKind, threadLocalInfo.locationIdentity, MemoryOrderMode.PLAIN));
